...
await ctx.runMutation(
  api.harness.tools.grazingAgentTools.createPlanWithPaddock,
  {
    farmExternalId: 'farm-1',
...
await ctx.runMutation(
  api.harness.tools.grazingAgentTools.finalizePlan,
  { farmExternalId: 'farm-1' }
)`,
      },
    },
...
const result = await ctx.runAction(
  api.harness.agent.grazingAgentGateway.agentGateway,
  {
